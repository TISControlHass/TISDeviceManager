...
<select name="{{ $field['name'] }}[]" style="width: 100%" data-init-function="bpFieldInitSelect2FromAjaxMultipleElement"
    ...
    data-allows-null="{{ var_export($field['allows_null']) }}" data-field-attribute="{{ $field['attribute'] }}"
    ...
    bp-field-main-input @include('crud::fields.inc.attributes', ['default_class' => 'form-control']) multiple>
